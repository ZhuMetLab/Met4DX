...
#### function to generate MS2 spectra from raw data 
...
tims_data <- CorrectRT(tims_data, param, ref_sample = "nist_urine_pos_1_p1-a1_1_4048.d") # reference sample for landmark-based RT alignment. we recommend to used the QC sample or the middle sample in the injection order
